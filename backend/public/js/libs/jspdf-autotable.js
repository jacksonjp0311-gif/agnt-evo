...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function i(t, e, n, i, a, s) {
        for (var u = new r.HtmlRowInput(i), d = 0; d < i.cells.length; d++) {
          ...
          if (a || 'none' !== h.display) {
            var f = void 0;
            s && (f = o.parseCss(t, c, e, h, n)), u.push({ rowSpan: c.rowSpan, colSpan: c.colSpan, styles: f, _element: c, content: l(c) });
          }
        }
      ...
      e.parseHtml = function (t, e, n, o, r) {
        ...
        var u = Object.keys(t.getFontList()),
          ...
          h = [],
          f = [];
        if (!s) return console.error('Html table could not be found with input: ', e), { head: c, body: h, foot: f };
        for (var p = 0; p < s.rows.length; p++) {
          var g = s.rows[p],
            y =
              null === (a = null === (l = null == g ? void 0 : g.parentElement) || void 0 === l ? void 0 : l.tagName) || void 0 === a
                ? void 0
                : a.toLowerCase(),
            v = i(u, d, n, g, o, r);
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.default = function (t, e, n, o, r) {
          ...
          if (
            ...
            (n += l * (2 - 1.15)),
            'middle' === o.valign ? (n -= (s / 2) * l * 1.15) : 'bottom' === o.valign && (n -= s * l * 1.15),
    ...
    function (t, e, n) {
      ...
      e.parseInput = function (t, e) {
        ...
        var f = (function (t, e, n) {
            for (
              var o = { styles: {}, headStyles: {}, bodyStyles: {}, footStyles: {}, alternateRowStyles: {}, columnStyles: {} },
                i = function (i) {
                  if ('columnStyles' === i) {
                    var l = t[i],
                      a = e[i],
      ...
      function c(t, e, n, o, r, l, s) {
        ...
        if (n.canEntireRowFit(u, s)) h(t, e, n, l, s);
          ...
          (function (t, e, n, o) {
            ...
            if (a > l)
              return (
                console.error('Will not be able to print row ' + e.index + " correctly since it's minimum height is larger than page height"), !0
              );
            if (!s) return !1;
            ...
            for (var l = 0, s = 0, u = n.columns; s < u.length; s++) {
              ...
              if ((m = t.cells[c.index])) {
                ...
                (m.contentHeight = m.getContentHeight(p)),
                  m.contentHeight >= e && ((m.contentHeight = e), (h.styles.minCellHeight -= e)),
          ...
          if (u)
            if ((t.applyStyles(u.styles), (u.x = o.x), (u.y = o.y), !1 !== e.callCellHooks(t, e.hooks.willDrawCell, u, n, a, o))) {
              ...
              s.default(
                ...
                d.x,
                d.y,
                { halign: u.styles.halign, valign: u.styles.valign, maxWidth: Math.ceil(u.width - u.padding('left') - u.padding('right')) },
                t.getDocument()
              ),
            ...
            if (null == a[y.index] || 0 === a[y.index].left)
              if (0 === f) {
                ...
                var b = d(t, y, s, i, o, l, m),
                  w = new r.Cell(v, b, t);
                (c[y.dataKey] = w), (c[y.index] = w), (f = w.colSpan - 1), (a[y.index] = { left: w.rowSpan - 1, times: f });
              } else f--, h++;
            ...
            var n = t.content,
              o = (function (t) {
                return t.map(function (t, e) {
                  var n, o, i;
                  return (
                    (i = 'object' == typeof t && null !== (o = null !== (n = t.dataKey) && void 0 !== n ? n : t.key) && void 0 !== o ? o : e),
                    new r.Column(i, t, e)
                  );
                });
              })(n.columns);
    ...
    function (t, e, n) {
      ...
      function o(t) {
        t.rowHeight
          ? (console.error('Use of deprecated style rowHeight. It is renamed to minCellHeight.'), t.minCellHeight || (t.minCellHeight = t.rowHeight))
          : t.columnWidth &&
            (console.error('Use of deprecated style columnWidth. It is renamed to cellWidth.'), t.cellWidth || (t.cellWidth = t.columnWidth));
      }
      Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          for (
            var i = function (e) {
                e && 'object' != typeof e && console.error('The options parameter should be of type object, is: ' + typeof e),
                  ...
                  void 0 !== e.margins &&
                    (void 0 === e.margin && (e.margin = e.margins), console.error('Use of deprecated option: margins, use margin instead.')),
                  e.startY && 'number' != typeof e.startY && (console.error('Invalid value for startY option', e.startY), delete e.startY),
                  !e.didDrawPage &&
      ...
      (e.calculateWidths = function (t, e) {
          ...
          e.allRows().forEach(function (r) {
            for (var i = 0, l = e.columns; i < l.length; i++) {
              ...
              if (s) {
                ...
                if (((s.minReadableWidth = c + s.padding('horizontal')), 'number' == typeof s.styles.cellWidth))
        ...
        a &&
          ...
          !e.settings.horizontalPageBreak &&
            a > 0.1 / t.scaleFactor() &&
            ((a = a < 1 ? a : Math.round(a)), console.error('Of the table content, ' + a + ' units width could not fit page')),
          (function (t) {
              ...
              for (var l = r[o], a = 0, s = t.columns; a < s.length; a++) {
                ...
                if (d) {
                  ...
                  'linebreak' === d.styles.overflow
                    ? (d.text = e.splitTextToSize(d.text, c + 1 / e.scaleFactor(), { fontSize: d.styles.fontSize }))
                    : 'ellipsize' === d.styles.overflow
                    ? (d.text = i(d.text, c, d.styles, e, '...'))
                    : 'hidden' === d.styles.overflow
                    ? (d.text = i(d.text, c, d.styles, e, ''))
                    : 'function' == typeof d.styles.overflow && (d.text = d.styles.overflow(d.text, c)),
