      ...
      function n(e, r, n, s, o, i, l, c) {
        ...
        return (
          c &&
            a.helper.isString(c) &&
            (h +=
              ' title="' + (c = c.replace(/"/g, '&quot;').replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'),
    ...
    a.subParser('stripLinkDefinitions', function (e, r, t) {
      ...
      var n = function (e, n, s, o, i, l, c) {
        return (
          ...
          l
            ? l + c
            : (c && (t.gTitles[n] = c.replace(/"|'/g, '&quot;')), r.parseImgDimensions && o && i && (t.gDimensions[n] = { width: o, height: i }), '')
        );
      };
      return (
        (e = (e += '¨0').replace(
